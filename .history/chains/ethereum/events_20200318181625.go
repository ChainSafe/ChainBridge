...
func (l *Listener) handleDepositEvent(eventI interface{}) msg.Message {
	...
	// }
	// }
	*ERC20HandlerCaller := ERC20Handler.ERC20HandlerCaller
	deposit, err := ERC20Handler.ERC20HandlerCaller.GetDepositRecord(&bind.CallOpts{}, originChainHandlerAddress, depositID)

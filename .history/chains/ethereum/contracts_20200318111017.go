...
type BridgeCaller interface {
	...
	GetDepositProposal(opts *bind.CallOpts, originChainID *big.Int, originChainHandlerAddress common.Address, depositID *big.Int) (type returnDepositProposal struct {
	OriginChainID *big.Int
	DepositID     *big.Int
	DataHash      [32]byte
	NumYes        *big.Int

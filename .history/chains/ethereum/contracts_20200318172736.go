...
type BridgeCaller interface {
	GetDepositRecord(opts *bind.CallOpts, originChainID *big.Int, originChainHandlerAddress common.Address, depositID *big.Int) (Bridge.BridgeReturnDepositProposal, error)
	GetDepositProposal(opts *bind.CallOpts, originChainID *big.Int, originChainHandlerAddress common.Address, depositID *big.Int) (Bridge.BridgeReturnDepositProposal, error)
}

...
type BridgeCaller interface {
	...
	GetDepositProposal(opts *bind.CallOpts, originChainID *big.Int, originChainHandlerAddress common.Address, depositID *big.Int) (BridgeReturnDepositProposal returnDepositProposal, error)
}

...
func (l *Listener) handleDepositEvent(eventI interface{}) msg.Message {
	...
	common.address originChainHandlerAddress = event.Topics[2]
	...
	deposit, err := l.bridgeContract.BridgeCaller.GetDepositRecord(&bind.CallOpts{}, originChainID, originChainHandlerAddress, depositID)
	if err != nil {

...
import (
	...
	ERC20Handler "github.com/ChainSafe/ChainBrideV2/contracts/ERC20Handler/ERC20Handler"
)
...
func (l *Listener) handleDepositEvent(eventI interface{}) msg.Message {
	...
	depositRecord, err := ERC20Handler.GetDepositRecord(&bind.CallOpts{}, originChainHandlerAddress, depositID)

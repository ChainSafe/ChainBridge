...
contract('Bridge - [deposit]', async (accounts) => {
    ...
    it('ERC20 deposit should be made with correct balances', async () => {
        await BridgeInstance.deposit(
            OriginERC20HandlerInstance.address, depositData);
        ...
        const handlerBalance = await OriginERC20MintableInstance.balanceOf(OriginERC20HandlerInstance.address);

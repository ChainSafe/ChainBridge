...
contract('Bridge - [deposit]', async (accounts) => {
    ...
    let originChainTokenAddress;
    let destinationChainHandlerAddress;
    ...
    beforeEach(async () => {
        ...
        ERC20HanOriginERC20HandlerInstancedlerInstance = await ERC20HandlerContract.new(BridgeInstance.address);

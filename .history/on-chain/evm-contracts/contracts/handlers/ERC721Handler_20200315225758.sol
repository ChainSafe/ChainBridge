...
contract ERC721Handler is IERC721Handler, IDepositHandler, ERC721Safe {
    ...
    function depositERC721(address tokenAddress, address owner, uint256 tokenID) public override _onlyBridge {
        lockERC721(tokenAddress, owner, address(this), tokenID);
    }

    function deposit(uint256 depositID, bytes memory data) public _onlyBridge {

...
contract Bridge {
    ...
    event DepositProposalVote(uint indexed originChainID, address indexed originChainHandlerAddress, uint indexed depositID, Vote indexed vote, DepositProposalStatus status);

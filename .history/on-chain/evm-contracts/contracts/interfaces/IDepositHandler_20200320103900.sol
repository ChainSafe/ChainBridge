...
interface IDepositHandler {
    ...
    function getDepositRecord(uint256 depositID) external returns (ERC20DepositRecord memory);
    function getDepositRecord(uint256 depositID) external returns (GenericDepositRecord memory);

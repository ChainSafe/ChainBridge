...
contract Bridge {
    ...
    event DepositProposalCreated(uint256 indexed originChainID, address indexed originChainHandlerAddress, uint indexed depositID, bytes32 dataHash);
    event DepositProposalVote(uint indexed originChainID, address indexed originChainHandlerAddress, uint indexed depositID, Vote vote, DepositProposalStatus status);
    event DepositProposalFinalized(uint indexed originChainID, address indexed originChainHandlerAddress, uint indexed depositID);

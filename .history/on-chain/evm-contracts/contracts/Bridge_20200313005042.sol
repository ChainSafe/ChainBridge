...
contract Bridge {
    ...
    unction getCurrentValidatorThresholdProposal() public view returns (ValidatorThresholdProposal memory) {
    ...
    function createDepositProposal(
        ...
        require(
            _depositProposals[originChainID][depositID]._status == DepositProposalStatus.Inactive ||
            _depositProposals[originChainID][depositID]._status == DepositProposalStatus.Denied,

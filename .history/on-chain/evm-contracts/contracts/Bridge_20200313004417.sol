...
contract Bridge {
    ...
    // handler address => depositID => depositProposal
    mapping(address => mapping(uint256 => DepositProposal)) public _depositProposals;
    ...
    function createDepositProposal(address , uint depositID, bytes32 dataHash) public _onlyValidators {

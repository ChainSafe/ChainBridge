...
contract Bridge {
    ...
    // handler address => depositID => bytes
    ...
    function getDepositRecord(address originChainHandlerAddress, uint256 depositID) public view returns (bytes) {
    ...
    function deposit(
        ...
        _depositRecords[handlerAddress][depositID] = data;

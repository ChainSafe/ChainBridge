...
contract Bridge {
    ...
    function getDepositProposal(uint256 originChainID, address originChainHandlerAddress, uint256 depositID) public view returns (DepositProposal memory) {
        return _depositProposals[handlerAddress][originChainHandlerAddress][deoi];
    }

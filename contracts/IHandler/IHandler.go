...
func NewIHandler(address common.Address, backend bind.ContractBackend) (*IHandler, error) {
	contract, err := bindIHandler(address, backend.(bind.ContractCaller), backend.(bind.ContractTransactor))
	if err != nil {
		return nil, err
	}
	return &IHandler{IHandlerCaller: IHandlerCaller{contract: contract}, IHandlerTransactor: IHandlerTransactor{contract: contract}}, nil
}
...
func NewIHandlerCaller(address common.Address, caller bind.ContractCaller) (*IHandlerCaller, error) {
	contract, err := bindIHandler(address, caller, nil)
	if err != nil {
		return nil, err
	}
...
func NewIHandlerTransactor(address common.Address, transactor bind.ContractTransactor) (*IHandlerTransactor, error) {
	contract, err := bindIHandler(address, nil, transactor)
	if err != nil {
		return nil, err
	}
...
func bindIHandler(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor) (*bind.BoundContract, error) {
